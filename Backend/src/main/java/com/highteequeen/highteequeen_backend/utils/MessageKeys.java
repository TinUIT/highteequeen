...
public class MessageKeys {
    ...
    public static final String INSERT_BRAND_SUCCESSFULLY = "brand.create_brand.create_successfully";
    public static final String INSERT_BRAND_FAILED = "brand.create_brand.create_failed";
    public static final String DELETE_BRAND_SUCCESSFULLY = "brand.delete_brand.delete_successfully";
    public static final String UPDATE_BRAND_SUCCESSFULLY = "brand.update_brand.update_successfully";
