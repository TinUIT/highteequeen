...
export default function ProductWarehouse() {
  ...
  const handleUpdateProduct = (id, name, price, image, brand_id, description, category_id, inStock, salesCount, discountPercent) => {
    setIsUpdateProduct(!isUpdateProduct);
    var item = {
      id, name, price, image, brand_id, description, category_id, inStock, salesCount, discountPercent
    }
    setProduct(item);
